...
<Callout>
  This is my addition as a `callout` box. In can have [links inside](https://www.google.com/), which should work just fine as before.
</Callout>
...
![image desc](https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80)
